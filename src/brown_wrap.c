...
#define SWIG_name      "brown"
#define SWIG_init      luaopen_brown
#define SWIG_init_user luaopen_brown_user

#define SWIG_LUACODE   luaopen_brown_luacode
...
static int _wrap_sp_brown_brown_set(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("sp_brown::brown",2,"SPFLOAT");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_SPFLOAT,0))){
    SWIG_fail_ptr("sp_brown_brown_set",2,SWIGTYPE_p_SPFLOAT);
  }
  arg2 = *argp2;
...
static int _wrap_sp_brown_sr_set(lua_State* L) {
  int SWIG_arg = 0;
  sp_brown *arg1 = (sp_brown *) 0 ;
  uint32_t arg2 ;
  
  SWIG_check_num_args("sp_brown::sr",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sp_brown::sr",1,"sp_brown *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("sp_brown::sr",2,"uint32_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_sp_brown,0))){
    SWIG_fail_ptr("sp_brown_sr_set",1,SWIGTYPE_p_sp_brown);
  }
...
static int _wrap_sp_brown_sr_get(lua_State* L) {
  int SWIG_arg = 0;
  sp_brown *arg1 = (sp_brown *) 0 ;
  uint32_t result;
  
  SWIG_check_num_args("sp_brown::sr",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sp_brown::sr",1,"sp_brown *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_sp_brown,0))){
    SWIG_fail_ptr("sp_brown_sr_get",1,SWIGTYPE_p_sp_brown);
  }
...
static int _wrap_new_sp_brown(lua_State* L) {
  ...
  result = (sp_brown *)calloc(1, sizeof(sp_brown));
...
static swig_lua_attribute swig_sp_brown_attributes[] = {
    ...
    { "sr", _wrap_sp_brown_sr_get, _wrap_sp_brown_sr_set },
    {0,0,0}
};
...
static int _wrap_Brown_brown_set(lua_State* L) {
  int SWIG_arg = 0;
  Brown *arg1 = (Brown *) 0 ;
  sp_brown *arg2 = (sp_brown *) 0 ;
  
  SWIG_check_num_args("Brown::brown",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Brown::brown",1,"Brown *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Brown::brown",2,"sp_brown *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Brown,0))){
    SWIG_fail_ptr("Brown_brown_set",1,SWIGTYPE_p_Brown);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_sp_brown,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("Brown_brown_set",2,SWIGTYPE_p_sp_brown);
  }
...
static int _wrap_Brown_brown_get(lua_State* L) {
  int SWIG_arg = 0;
  Brown *arg1 = (Brown *) 0 ;
  sp_brown *result = 0 ;
  
  SWIG_check_num_args("Brown::brown",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Brown::brown",1,"Brown *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Brown,0))){
    SWIG_fail_ptr("Brown_brown_get",1,SWIGTYPE_p_Brown);
  }
  
  result = (sp_brown *) ((arg1)->brown);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_sp_brown,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_Brown(lua_State* L) {
  int SWIG_arg = 0;
  Brown *result = 0 ;
  
  SWIG_check_num_args("Brown::Brown",0,0)
  result = (Brown *)calloc(1, sizeof(Brown));
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Brown,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_Brown(void *obj) {
Brown *arg1 = (Brown *) obj;
free((char *) arg1);
}
static int _proxy__wrap_new_Brown(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_Brown);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_Brown_attributes[] = {
    { "brown", _wrap_Brown_brown_get, _wrap_Brown_brown_set },
    {0,0,0}
};
static swig_lua_method swig_Brown_methods[]= {
    {0,0}
};
static swig_lua_method swig_Brown_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Brown_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Brown_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Brown_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Brown_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Brown_Sf_SwigStatic = {
    "Brown",
    swig_Brown_Sf_SwigStatic_methods,
    swig_Brown_Sf_SwigStatic_attributes,
    swig_Brown_Sf_SwigStatic_constants,
    swig_Brown_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Brown_bases[] = {0};
static const char *swig_Brown_base_names[] = {0};
static swig_lua_class _wrap_class_Brown = { "Brown", "Brown", &SWIGTYPE_p_Brown,_proxy__wrap_new_Brown, swig_delete_Brown, swig_Brown_methods, swig_Brown_attributes, &swig_Brown_Sf_SwigStatic, swig_Brown_meta, swig_Brown_bases, swig_Brown_base_names };
...
static int _wrap_sp_brown_init(lua_State* L) {
  ...
  if(!lua_isnumber(L,1)) SWIG_fail_arg("sp_brown_init",1,"uint32_t");
...
static int _wrap_sp_brown_compute(lua_State* L) {
  ...
  SWIG_check_num_args("sp_brown_compute",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sp_brown_compute",1,"sp_brown *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("sp_brown_compute",2,"SPFLOAT *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("sp_brown_compute",3,"SPFLOAT *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_sp_brown,0))){
    SWIG_fail_ptr("sp_brown_compute",1,SWIGTYPE_p_sp_brown);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_SPFLOAT,0))){
    SWIG_fail_ptr("sp_brown_compute",2,SWIGTYPE_p_SPFLOAT);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_SPFLOAT,0))){
    SWIG_fail_ptr("sp_brown_compute",3,SWIGTYPE_p_SPFLOAT);
  }
  
  result = (int)sp_brown_compute(arg1,arg2,arg3);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Brown_New(lua_State* L) {
  int SWIG_arg = 0;
  uint32_t arg1 ;
  Brown *result = 0 ;
  
  SWIG_check_num_args("Brown_New",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Brown_New",1,"uint32_t");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative")
  arg1 = (uint32_t)lua_tonumber(L, 1);
  result = (Brown *)Brown_New(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Brown,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Brown_Tick(lua_State* L) {
  int SWIG_arg = 0;
  Brown *arg1 = (Brown *) 0 ;
  float result;
  
  SWIG_check_num_args("Brown_Tick",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Brown_Tick",1,"Brown *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Brown,0))){
    SWIG_fail_ptr("Brown_Tick",1,SWIGTYPE_p_Brown);
  }
  
  result = (float)Brown_Tick(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "Brown_New", _wrap_Brown_New},
    { "Brown_Tick", _wrap_Brown_Tick},
    {0,0}
};
...
static swig_type_info _swigt__p_Brown = {"_p_Brown", "Brown *", 0, 0, (void*)&_wrap_class_Brown, 0};
...
static swig_cast_info _swigc__p_Brown[] = {  {&_swigt__p_Brown, 0, 0, 0},{0, 0, 0, 0}};
