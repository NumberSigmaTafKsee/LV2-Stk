...
namespace Filters::AAFilter
{
    ...
    struct AAUpSampleFilter : public AAFilter<float>
    {
        AAUpSampleFilter(double sr)    
        {
            this->Init(sr);
        }
        ...
        {
            return this->ProcessUp(I);
        }
    };

    struct AADownSampleFilter : public AAFilter<float>
    {
        AADownSampleFilter(double sr)
        {
            this->Init(sr);
        }
