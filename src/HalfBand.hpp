...
inline CAllPassFilter::CAllPassFilter(const double coefficient)
{
	a=coefficient;
...
inline CAllPassFilter::~CAllPassFilter()
{
};


inline double CAllPassFilter::process(const double input)
{
	//shuffle inputs
	x2=x1;
	x1=x0;
...
inline CAllPassFilterCascade::CAllPassFilterCascade(const double* coefficient, const int N)
{
...
inline CAllPassFilterCascade::~CAllPassFilterCascade()
{
	delete[] allpassfilter;
};


inline double CAllPassFilterCascade::process(const double input)
{
	double output=input;
...
inline CHalfBandFilter::CHalfBandFilter(const int order, const bool steep)
{
	if (steep==true)
	{
...
inline CHalfBandFilter::~CHalfBandFilter()
{
	delete filter_a;
	delete filter_b;
};
...
inline double CHalfBandFilter::process(const double input)
{
