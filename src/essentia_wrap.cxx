...
#define SWIGTYPE_p_essentia__standard__Algorithm swig_types[1]
#define SWIGTYPE_p_essentia__standard__AlgorithmFactory swig_types[2]
...
#define SWIG_name      "essentia"
#define SWIG_init      luaopen_essentia
#define SWIG_init_user luaopen_essentia_user

#define SWIG_LUACODE   luaopen_essentia_luacode
...
static int _wrap_Algorithm_processingMode_get(lua_State* L) {
  int SWIG_arg = 0;
  std::string *result = 0 ;
  
  SWIG_check_num_args("essentia::standard::Algorithm::processingMode",0,0)
  result = (std::string *) &essentia::standard::Algorithm::processingMode;
  lua_pushlstring(L,result->data(),result->size()); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Algorithm_inputNames(lua_State* L) {
  int SWIG_arg = 0;
  essentia::standard::Algorithm *arg1 = (essentia::standard::Algorithm *) 0 ;
  SwigValueWrapper< std::vector< std::string > > result;
  
  SWIG_check_num_args("essentia::standard::Algorithm::inputNames",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("essentia::standard::Algorithm::inputNames",1,"essentia::standard::Algorithm const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_essentia__standard__Algorithm,0))){
    SWIG_fail_ptr("Algorithm_inputNames",1,SWIGTYPE_p_essentia__standard__Algorithm);
  }
...
static int _wrap_Algorithm_outputNames(lua_State* L) {
  int SWIG_arg = 0;
  essentia::standard::Algorithm *arg1 = (essentia::standard::Algorithm *) 0 ;
  SwigValueWrapper< std::vector< std::string > > result;
  
  SWIG_check_num_args("essentia::standard::Algorithm::outputNames",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("essentia::standard::Algorithm::outputNames",1,"essentia::standard::Algorithm const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_essentia__standard__Algorithm,0))){
    SWIG_fail_ptr("Algorithm_outputNames",1,SWIGTYPE_p_essentia__standard__Algorithm);
  }
...
static int _wrap_Algorithm_compute(lua_State* L) {
  int SWIG_arg = 0;
  essentia::standard::Algorithm *arg1 = (essentia::standard::Algorithm *) 0 ;
  
  SWIG_check_num_args("essentia::standard::Algorithm::compute",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("essentia::standard::Algorithm::compute",1,"essentia::standard::Algorithm *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_essentia__standard__Algorithm,0))){
    SWIG_fail_ptr("Algorithm_compute",1,SWIGTYPE_p_essentia__standard__Algorithm);
  }
...
static int _wrap_Algorithm_reset(lua_State* L) {
  int SWIG_arg = 0;
  essentia::standard::Algorithm *arg1 = (essentia::standard::Algorithm *) 0 ;
  
  SWIG_check_num_args("essentia::standard::Algorithm::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("essentia::standard::Algorithm::reset",1,"essentia::standard::Algorithm *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_essentia__standard__Algorithm,0))){
    SWIG_fail_ptr("Algorithm_reset",1,SWIGTYPE_p_essentia__standard__Algorithm);
  }
...
static void swig_delete_Algorithm(void *obj) {
essentia::standard::Algorithm *arg1 = (essentia::standard::Algorithm *) obj;
delete arg1;
}
static swig_lua_attribute swig_Algorithm_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Algorithm_methods[]= {
    { "inputNames", _wrap_Algorithm_inputNames},
    { "outputNames", _wrap_Algorithm_outputNames},
    { "compute", _wrap_Algorithm_compute},
    { "reset", _wrap_Algorithm_reset},
    {0,0}
};
static swig_lua_method swig_Algorithm_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Algorithm_Sf_SwigStatic_attributes[] = {
    { "processingMode", _wrap_Algorithm_processingMode_get, SWIG_Lua_set_immutable },
    {0,0,0}
};
static swig_lua_const_info swig_Algorithm_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Algorithm_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Algorithm_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Algorithm_Sf_SwigStatic = {
    "Algorithm",
    swig_Algorithm_Sf_SwigStatic_methods,
    swig_Algorithm_Sf_SwigStatic_attributes,
    swig_Algorithm_Sf_SwigStatic_constants,
    swig_Algorithm_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Algorithm_bases[] = {0};
static const char *swig_Algorithm_base_names[] = {0};
static swig_lua_class _wrap_class_Algorithm = { "Algorithm", "Algorithm", &SWIGTYPE_p_essentia__standard__Algorithm,0, swig_delete_Algorithm, swig_Algorithm_methods, swig_Algorithm_attributes, &swig_Algorithm_Sf_SwigStatic, swig_Algorithm_meta, swig_Algorithm_bases, swig_Algorithm_base_names };

static int _wrap_factory_set(lua_State* L) {
  int SWIG_arg = 0;
  essentia::standard::AlgorithmFactory *arg1 = 0 ;
  
  SWIG_check_num_args("factory",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("factory",1,"essentia::standard::AlgorithmFactory &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_essentia__standard__AlgorithmFactory,0))){
    SWIG_fail_ptr("factory_set",1,SWIGTYPE_p_essentia__standard__AlgorithmFactory);
  }
...
static int _wrap_factory_get(lua_State* L) {
  int SWIG_arg = 0;
  essentia::standard::AlgorithmFactory *result = 0 ;
  
  SWIG_check_num_args("factory",0,0)
  result = (essentia::standard::AlgorithmFactory *) &(essentia::standard::AlgorithmFactory &)factory;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_essentia__standard__AlgorithmFactory,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_create_algorithm(lua_State* L) {
  int SWIG_arg = 0;
  std::string *arg1 = 0 ;
  std::string temp1 ;
  essentia::standard::Algorithm *result = 0 ;
  
  SWIG_check_num_args("create_algorithm",1,1)
  if(!lua_isstring(L,1)) SWIG_fail_arg("create_algorithm",1,"std::string const &");
  temp1.assign(lua_tostring(L,1),lua_rawlen(L,1)); arg1=&temp1;
  result = (essentia::standard::Algorithm *)create_algorithm((std::string const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_essentia__standard__Algorithm,0); SWIG_arg++; 
  return SWIG_arg;
...
static swig_lua_attribute swig_SwigModule_attributes[] = {
    { "Algorithm_processingMode", _wrap_Algorithm_processingMode_get, SWIG_Lua_set_immutable },
    { "factory", _wrap_factory_get, _wrap_factory_set },
    {0,0,0}
};
...
static swig_lua_method swig_SwigModule_methods[]= {
    { "create_algorithm", _wrap_create_algorithm},
    {0,0}
};
...
static swig_type_info _swigt__p_essentia__standard__Algorithm = {"_p_essentia__standard__Algorithm", "essentia::standard::Algorithm *", 0, 0, (void*)&_wrap_class_Algorithm, 0};
static swig_type_info _swigt__p_essentia__standard__AlgorithmFactory = {"_p_essentia__standard__AlgorithmFactory", "essentia::standard::AlgorithmFactory *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_essentia__standard__AlgorithmFactory,
  &_swigt__p_float,
  &_swigt__p_int32_t,
  &_swigt__p_int64_t,
...
static swig_cast_info _swigc__p_essentia__standard__AlgorithmFactory[] = {  {&_swigt__p_essentia__standard__AlgorithmFactory, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_essentia__standard__AlgorithmFactory,
  _swigc__p_float,
  _swigc__p_int32_t,
  _swigc__p_int64_t,
