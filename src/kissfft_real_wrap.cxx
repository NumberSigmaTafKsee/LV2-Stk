...
SWIGINTERN std::vector_iterator< kiss_fft_cpx > std_vector_Sl_kiss_fft_cpx_Sg__ibegin__SWIG(std::vector< kiss_fft_cpx > *self){
                std::vector_iterator<kiss_fft_cpx> r(*self,self->begin());                
                return r;
            }
SWIGINTERN std::vector_iterator< kiss_fft_cpx > std_vector_Sl_kiss_fft_cpx_Sg__iend__SWIG(std::vector< kiss_fft_cpx > *self){
...
static int _wrap_real_vector_ibegin(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = (std::vector< float > *) 0 ;
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("real_vector_ibegin",1,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static int _wrap_real_vector_iend(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = (std::vector< float > *) 0 ;
  SwigValueWrapper< std::vector_iterator< float > > result;
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("real_vector_iend",1,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static swig_lua_method swig_real_vector_methods[]= {
    ...
    { "ibegin", _wrap_real_vector_ibegin},
    { "iend", _wrap_real_vector_iend},
...
static int _wrap_complex_vector_ibegin(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< kiss_fft_cpx >::ibegin",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< kiss_fft_cpx >::ibegin",1,"std::vector< kiss_fft_cpx > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_kiss_fft_cpx_t,0))){
    SWIG_fail_ptr("complex_vector_ibegin",1,SWIGTYPE_p_std__vectorT_kiss_fft_cpx_t);
  }
  
  result = std_vector_Sl_kiss_fft_cpx_Sg__ibegin__SWIG(arg1);
  {
...
static int _wrap_complex_vector_iend(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< kiss_fft_cpx >::iend",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< kiss_fft_cpx >::iend",1,"std::vector< kiss_fft_cpx > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_kiss_fft_cpx_t,0))){
    SWIG_fail_ptr("complex_vector_iend",1,SWIGTYPE_p_std__vectorT_kiss_fft_cpx_t);
  }
  
  result = std_vector_Sl_kiss_fft_cpx_Sg__iend__SWIG(arg1);
  {
    std::vector_iterator< kiss_fft_cpx > * resultptr = new std::vector_iterator< kiss_fft_cpx >((const std::vector_iterator< kiss_fft_cpx > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__vector_iteratorT_kiss_fft_cpx_t,1); SWIG_arg++;
  }
