...
namespace Filters::Allpass
{
    ...
    public:
        ...
        double Tick(double input, double A=1, double X=0, double Y=1) {
            ...
            double output = linterp(buffer[r], buffer[upperR], f);
    ...
    public:
        ...
        double Tick(double I=0, double A=0, double X=0, double Y=0) {
...
using InterpDelayProcessor   = Filters::Allpass::InterpDelay2<float>;
using AllpassFilterProcessor = Filters::Allpass::AllpassFilter<float>;
using NestedAllpassType1Processor = Filters::Allpass::NestedAllPassType1<float>;