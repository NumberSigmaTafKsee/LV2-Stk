...
inline bool normalizeBuffer(double* pInputBuffer, uint32_t uBufferSize)
{
	double fMax = 0;
...
inline modMatrixRow* createModMatrixRow(uint32_t uSource, uint32_t uDestination, double* pIntensity, double* pRange, uint32_t uTransform, bool bEnable = true)
{
...
/* mmaMIDItoParamScaling()
	...
	Examples:
		...
		Key to EG Decay Time: decay shortens as MIDI note number increases
							  ...
							  fScaling = Vel to EG Attack Scale
*/
inline double mmaMIDItoParamScaling(uint32_t uMIDIValue, float fParameter, float fScaling)
{
...
*/
inline double mmaMIDItoAtten_dB(uint32_t uMIDIValue)
{
	if(uMIDIValue == 0)
...
/* mmaMIDItoAtten()
	...
	uMIDIValue = the MIDI (0 -> 127) value to convert
*/
inline double mmaMIDItoAtten(uint32_t uMIDIValue)
{
	if(uMIDIValue == 0)
		return 0.0; // floor
...
*/
inline double midiToBipolar(uint32_t uMIDIValue)
{
...
/* midiToPanValue()
	...
	uint32_t uMIDIValue = the MIDI value to convert
*/
inline double midiToPanValue(uint32_t uMIDIValue)
{
...
/* midiToUnipolar()
	...
	dValue = the value to convert
*/
inline double midiToUnipolar(uint32_t uMIDIValue)
{
...
/* unipolarToMIDI()
	...
	dValue = the value to convert
*/
inline uint32_t unipolarToMIDI(float fUnipolarValue)
{
...
inline double doWhiteNoise()
{
	...
	fNoise = (float)rand() / (float) RAND_MAX; // ???(float)arc4random();
