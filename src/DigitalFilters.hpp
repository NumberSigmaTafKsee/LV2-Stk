...
namespace Filters::DigitalFilters
{
	template<typename T>
	...
	public:
		...
		virtual double Tick(double I, double A=1, double X=1, double Y=1)
		{
			double r = update(I);
			return A*r;
		}
	...
	*/
	...
	public:
		MovingAvarageFilter : DigitalFilter<double>() {}
