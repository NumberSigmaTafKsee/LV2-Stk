...
#define SWIGTYPE_p_Filters__AAFilter__AADownSampleFilter swig_types[0]
#define SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t swig_types[1]
#define SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t swig_types[2]
#define SWIGTYPE_p_Filters__AAFilter__AAUpSampleFilter swig_types[3]
#define SWIGTYPE_p_double swig_types[4]
#define SWIGTYPE_p_f_double__double swig_types[5]
#define SWIGTYPE_p_f_float__float swig_types[6]
#define SWIGTYPE_p_f_r_q_const__double__double swig_types[7]
...
#define SWIGTYPE_p_std__gslice_arrayT_double_t swig_types[21]
#define SWIGTYPE_p_std__gslice_arrayT_float_t swig_types[22]
#define SWIGTYPE_p_std__indirect_arrayT_double_t swig_types[23]
#define SWIGTYPE_p_std__indirect_arrayT_float_t swig_types[24]
#define SWIGTYPE_p_std__mask_arrayT_double_t swig_types[25]
...
#define SWIGTYPE_p_std__vectorT_float_t swig_types[43]
...
#define SWIG_name      "aafilter"
#define SWIG_init      luaopen_aafilter
#define SWIG_init_user luaopen_aafilter_user

#define SWIG_LUACODE   luaopen_aafilter_luacode
...
SWIGINTERN double std_valarray_Sl_double_Sg____getitem__SWIG(std::valarray< double > *self,size_t i){ return (*self)[i]; }
SWIGINTERN void std_valarray_Sl_double_Sg____setitem__SWIG(std::valarray< double > *self,size_t i,double const &v){ (*self)[i] = v; }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____add____SWIG(std::valarray< double > *self,std::valarray< double > const &b){ return *self + b; }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____sub____SWIG(std::valarray< double > *self,std::valarray< double > const &b){ return *self - b; }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____mul____SWIG(std::valarray< double > *self,std::valarray< double > const &b){ return *self * b; }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____div____SWIG(std::valarray< double > *self,std::valarray< double > const &b){ return *self / b; }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____unm____SWIG(std::valarray< double > *self,std::valarray< double > const &b){ return -*self; }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____pow____SWIG_0(std::valarray< double > *self,std::valarray< double > const &b){ return std::pow(*self,b); }
SWIGINTERN std::valarray< double > std_valarray_Sl_double_Sg____pow____SWIG_1(std::valarray< double > *self,double const &b){ return std::pow(*self,b); }
...
static int _wrap_new_double_valarray__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",0,0)
  result = (std::valarray< double > *)new std::valarray< double >();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  size_t arg1 ;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"size_t");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (size_t)lua_tonumber(L, 1);
  result = (std::valarray< double > *)new std::valarray< double >(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_2(lua_State* L) {
  int SWIG_arg = 0;
  double *arg1 = 0 ;
  size_t arg2 ;
  double temp1 ;
  ...
  SWIG_check_num_args("std::valarray< double >::valarray",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"double const &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::valarray",2,"size_t");
  temp1=(double)lua_tonumber(L,1); arg1=&temp1;
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (size_t)lua_tonumber(L, 2);
  result = (std::valarray< double > *)new std::valarray< double >((double const &)*arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_3(lua_State* L) {
  int SWIG_arg = 0;
  ...
  SWIG_check_num_args("std::valarray< double >::valarray",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"double const *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::valarray",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("new_double_valarray",1,SWIGTYPE_p_double);
  }
...
static int _wrap_new_double_valarray__SWIG_4(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = 0 ;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("new_double_valarray",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = (std::valarray< double > *)new std::valarray< double >((std::valarray< double > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_5(lua_State* L) {
  int SWIG_arg = 0;
  std::slice_array< double > *arg1 = 0 ;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"std::slice_array< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__slice_arrayT_double_t,0))){
    SWIG_fail_ptr("new_double_valarray",1,SWIGTYPE_p_std__slice_arrayT_double_t);
  }
  
  result = (std::valarray< double > *)new std::valarray< double >((std::slice_array< double > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_6(lua_State* L) {
  int SWIG_arg = 0;
  std::gslice_array< double > *arg1 = 0 ;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"std::gslice_array< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__gslice_arrayT_double_t,0))){
    SWIG_fail_ptr("new_double_valarray",1,SWIGTYPE_p_std__gslice_arrayT_double_t);
  }
  
  result = (std::valarray< double > *)new std::valarray< double >((std::gslice_array< double > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_7(lua_State* L) {
  int SWIG_arg = 0;
  std::mask_array< double > *arg1 = 0 ;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"std::mask_array< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__mask_arrayT_double_t,0))){
    SWIG_fail_ptr("new_double_valarray",1,SWIGTYPE_p_std__mask_arrayT_double_t);
  }
  
  result = (std::valarray< double > *)new std::valarray< double >((std::mask_array< double > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray__SWIG_8(lua_State* L) {
  int SWIG_arg = 0;
  std::indirect_array< double > *arg1 = 0 ;
  std::valarray< double > *result = 0 ;
  
  SWIG_check_num_args("std::valarray< double >::valarray",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::valarray< double >::valarray",1,"std::indirect_array< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__indirect_arrayT_double_t,0))){
    SWIG_fail_ptr("new_double_valarray",1,SWIGTYPE_p_std__indirect_arrayT_double_t);
  }
  
  result = (std::valarray< double > *)new std::valarray< double >((std::indirect_array< double > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_double_valarray(lua_State* L) {
  int argc;
  int argv[3]={
    1,2,3
  };
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_double_valarray__SWIG_0(L);
  }
  if (argc == 1) {
    int _v = 0;
    {
    ...
    if (_v) {
      return _wrap_new_double_valarray__SWIG_4(L);
    }
  }
  if (argc == 1) {
    int _v = 0;
    ...
    if (_v) {
      return _wrap_new_double_valarray__SWIG_5(L);
    }
  }
  if (argc == 1) {
    int _v = 0;
    ...
    if (_v) {
      return _wrap_new_double_valarray__SWIG_6(L);
    }
  }
  if (argc == 1) {
    int _v = 0;
    {
      void *ptr;
      if (lua_isuserdata(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_std__mask_arrayT_double_t, SWIG_POINTER_NO_NULL)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      return _wrap_new_double_valarray__SWIG_7(L);
    }
  }
  if (argc == 1) {
    int _v = 0;
    {
      void *ptr;
      if (lua_isuserdata(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_std__indirect_arrayT_double_t, SWIG_POINTER_NO_NULL)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      return _wrap_new_double_valarray__SWIG_8(L);
    }
  }
  if (argc == 1) {
    int _v = 0;
    ...
    if (_v) {
      return _wrap_new_double_valarray__SWIG_1(L);
    }
  }
  if (argc == 2) {
    int _v = 0;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_new_double_valarray__SWIG_3(L);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_new_double_valarray__SWIG_2(L);
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_double_valarray'\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::valarray< double >::valarray()\n"
    "    std::valarray< double >::valarray(size_t)\n"
    "    std::valarray< double >::valarray(double const &,size_t)\n"
    "    std::valarray< double >::valarray(double const *,size_t)\n"
    "    std::valarray< double >::valarray(std::valarray< double > const &)\n"
    "    std::valarray< double >::valarray(std::slice_array< double > const &)\n"
    "    std::valarray< double >::valarray(std::gslice_array< double > const &)\n"
    "    std::valarray< double >::valarray(std::mask_array< double > const &)\n"
    "    std::valarray< double >::valarray(std::indirect_array< double > const &)\n");
  lua_error(L);return 0;
}


static int _wrap_double_valarray___getitem(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  size_t arg2 ;
  double result;
  
  SWIG_check_num_args("std::valarray< double >::__getitem",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__getitem",1,"std::valarray< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::__getitem",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___getitem",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (size_t)lua_tonumber(L, 2);
  result = (double)std_valarray_Sl_double_Sg____getitem__SWIG(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_double_valarray___setitem(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  size_t arg2 ;
  double *arg3 = 0 ;
  ...
  SWIG_check_num_args("std::valarray< double >::__setitem",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__setitem",1,"std::valarray< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::__setitem",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("std::valarray< double >::__setitem",3,"double const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___setitem",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (size_t)lua_tonumber(L, 2);
  temp3=(double)lua_tonumber(L,3); arg3=&temp3;
  std_valarray_Sl_double_Sg____setitem__SWIG(arg1,arg2,(double const &)*arg3);
...
static int _wrap_double_valarray___add(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  std::valarray< double > *arg2 = 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::__add__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__add__",1,"std::valarray< double > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::valarray< double >::__add__",2,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___add",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___add",2,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = std_valarray_Sl_double_Sg____add____SWIG(arg1,(std::valarray< double > const &)*arg2);
  {
...
static int _wrap_double_valarray___sub(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  std::valarray< double > *arg2 = 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::__sub__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__sub__",1,"std::valarray< double > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::valarray< double >::__sub__",2,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___sub",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___sub",2,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = std_valarray_Sl_double_Sg____sub____SWIG(arg1,(std::valarray< double > const &)*arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray___mul(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  std::valarray< double > *arg2 = 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::__mul__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__mul__",1,"std::valarray< double > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::valarray< double >::__mul__",2,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___mul",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___mul",2,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = std_valarray_Sl_double_Sg____mul____SWIG(arg1,(std::valarray< double > const &)*arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray___div(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  std::valarray< double > *arg2 = 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::__div__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__div__",1,"std::valarray< double > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::valarray< double >::__div__",2,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___div",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___div",2,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = std_valarray_Sl_double_Sg____div____SWIG(arg1,(std::valarray< double > const &)*arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray___unm__(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  std::valarray< double > *arg2 = 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::__unm__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__unm__",1,"std::valarray< double > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::valarray< double >::__unm__",2,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___unm__",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___unm__",2,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = std_valarray_Sl_double_Sg____unm____SWIG(arg1,(std::valarray< double > const &)*arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray___pow__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  std::valarray< double > *arg2 = 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::__pow__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__pow__",1,"std::valarray< double > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::valarray< double >::__pow__",2,"std::valarray< double > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___pow",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray___pow",2,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = std_valarray_Sl_double_Sg____pow____SWIG_0(arg1,(std::valarray< double > const &)*arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray___pow__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  double *arg2 = 0 ;
  double temp2 ;
  ...
  SWIG_check_num_args("std::valarray< double >::__pow__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::__pow__",1,"std::valarray< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::__pow__",2,"double const &");
  ...
  temp2=(double)lua_tonumber(L,2); arg2=&temp2;
  result = std_valarray_Sl_double_Sg____pow____SWIG_1(arg1,(double const &)*arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray___pow(lua_State* L) {
  int argc;
  int argv[3]={
    1,2,3
  };
  ...
  if (argc == 2) {
    ...
    {
      void *ptr;
      if (SWIG_isptrtype(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_std__valarrayT_double_t, 0)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      {
        void *ptr;
        if (lua_isuserdata(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_std__valarrayT_double_t, SWIG_POINTER_NO_NULL)) {
          _v = 0;
        } else {
          _v = 1;
        }
      ...
      if (_v) {
        return _wrap_double_valarray___pow__SWIG_0(L);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_double_valarray___pow__SWIG_1(L);
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'double_valarray___pow'\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::valarray< double >::__pow__(std::valarray< double > const &)\n"
    "    std::valarray< double >::__pow__(double const &)\n");
  lua_error(L);return 0;
}


static int _wrap_double_valarray_size(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  size_t result;
  
  SWIG_check_num_args("std::valarray< double >::size",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::size",1,"std::valarray< double > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_size",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = ((std::valarray< double > const *)arg1)->size();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_double_valarray_resize__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  size_t arg2 ;
  double arg3 ;
  
  SWIG_check_num_args("std::valarray< double >::resize",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::resize",1,"std::valarray< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::resize",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("std::valarray< double >::resize",3,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_resize",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
...
static int _wrap_double_valarray_resize__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  size_t arg2 ;
  
  SWIG_check_num_args("std::valarray< double >::resize",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::resize",1,"std::valarray< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::resize",2,"size_t");
...
static int _wrap_double_valarray_resize(lua_State* L) {
  int argc;
  int argv[4]={
    1,2,3,4
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_double_valarray_resize__SWIG_1(L);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_double_valarray_resize__SWIG_0(L);
        }
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'double_valarray_resize'\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::valarray< double >::resize(size_t,double)\n"
    "    std::valarray< double >::resize(size_t)\n");
  lua_error(L);return 0;
}


static int _wrap_double_valarray_sum(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  double result;
  
  SWIG_check_num_args("std::valarray< double >::sum",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::sum",1,"std::valarray< double > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_sum",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = (double)((std::valarray< double > const *)arg1)->sum();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_double_valarray_min(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  double result;
  
  SWIG_check_num_args("std::valarray< double >::min",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::min",1,"std::valarray< double > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_min",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = (double)((std::valarray< double > const *)arg1)->min();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_double_valarray_max(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  double result;
  
  SWIG_check_num_args("std::valarray< double >::max",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::max",1,"std::valarray< double > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_max",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  result = (double)((std::valarray< double > const *)arg1)->max();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_double_valarray_shift(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  int arg2 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::shift",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::shift",1,"std::valarray< double > const *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::shift",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_shift",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = ((std::valarray< double > const *)arg1)->shift(arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray_cshift(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  int arg2 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::cshift",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::cshift",1,"std::valarray< double > const *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::valarray< double >::cshift",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_cshift",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  result = ((std::valarray< double > const *)arg1)->cshift(arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray_apply__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  double (*arg2)(double) = (double (*)(double)) 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::apply",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::apply",1,"std::valarray< double > const *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("std::valarray< double >::apply",2,"double (*)(double)");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__valarrayT_double_t,0))){
    SWIG_fail_ptr("double_valarray_apply",1,SWIGTYPE_p_std__valarrayT_double_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_f_double__double,0))){
    SWIG_fail_ptr("double_valarray_apply",2,SWIGTYPE_p_f_double__double);
  }
  
  result = ((std::valarray< double > const *)arg1)->apply(arg2);
  {
    std::valarray< double > * resultptr = new std::valarray< double >((const std::valarray< double > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__valarrayT_double_t,1); SWIG_arg++;
  }
...
static int _wrap_double_valarray_apply__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  std::valarray< double > *arg1 = (std::valarray< double > *) 0 ;
  double (*arg2)(double const &) = (double (*)(double const &)) 0 ;
  std::valarray< double > result;
  
  SWIG_check_num_args("std::valarray< double >::apply",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::valarray< double >::apply",1,"std::valarray< double > const *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("std::valarray< double >::apply",2,"double (*)(double const &)");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_f_r_q_const__double__double,0))){
    SWIG_fail_ptr("double_valarray_apply",2,SWIGTYPE_p_f_r_q_const__double__double);
  }
...
static int _wrap_double_valarray_apply(lua_State* L) {
  int argc;
  int argv[3]={
    1,2,3
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      {
        void *ptr;
        if (SWIG_isptrtype(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_f_double__double, 0)) {
          _v = 0;
        } else {
          _v = 1;
        }
      ...
      if (_v) {
        return _wrap_double_valarray_apply__SWIG_0(L);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      {
        void *ptr;
        if (SWIG_isptrtype(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_f_r_q_const__double__double, 0)) {
          _v = 0;
        } else {
          _v = 1;
        }
      ...
      if (_v) {
        return _wrap_double_valarray_apply__SWIG_1(L);
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'double_valarray_apply'\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::valarray< double >::apply(double (*)(double)) const\n"
    "    std::valarray< double >::apply(double (*)(double const &)) const\n");
  lua_error(L);return 0;
}


static void swig_delete_double_valarray(void *obj) {
std::valarray< double > *arg1 = (std::valarray< double > *) obj;
delete arg1;
}
static int _proxy__wrap_new_double_valarray(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_double_valarray);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_double_valarray_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_double_valarray_methods[]= {
    { "__getitem", _wrap_double_valarray___getitem},
    { "__setitem", _wrap_double_valarray___setitem},
    { "__add", _wrap_double_valarray___add},
    { "__sub", _wrap_double_valarray___sub},
    { "__mul", _wrap_double_valarray___mul},
    { "__div", _wrap_double_valarray___div},
    { "__unm__", _wrap_double_valarray___unm__},
    { "__pow", _wrap_double_valarray___pow},
    { "size", _wrap_double_valarray_size},
    { "resize", _wrap_double_valarray_resize},
    { "sum", _wrap_double_valarray_sum},
    { "min", _wrap_double_valarray_min},
    { "max", _wrap_double_valarray_max},
    { "shift", _wrap_double_valarray_shift},
    { "cshift", _wrap_double_valarray_cshift},
    { "apply", _wrap_double_valarray_apply},
    {0,0}
};
static swig_lua_method swig_double_valarray_meta[] = {
    { "__getitem", _wrap_double_valarray___getitem},
    { "__setitem", _wrap_double_valarray___setitem},
    { "__add", _wrap_double_valarray___add},
    { "__sub", _wrap_double_valarray___sub},
...
static swig_lua_attribute swig_double_valarray_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_double_valarray_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_double_valarray_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_double_valarray_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_double_valarray_Sf_SwigStatic = {
    "double_valarray",
    swig_double_valarray_Sf_SwigStatic_methods,
    swig_double_valarray_Sf_SwigStatic_attributes,
    swig_double_valarray_Sf_SwigStatic_constants,
    swig_double_valarray_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_double_valarray_bases[] = {0};
static const char *swig_double_valarray_base_names[] = {0};
static swig_lua_class _wrap_class_double_valarray = { "double_valarray", "double_valarray", &SWIGTYPE_p_std__valarrayT_double_t,_proxy__wrap_new_double_valarray, swig_delete_double_valarray, swig_double_valarray_methods, swig_double_valarray_attributes, &swig_double_valarray_Sf_SwigStatic, swig_double_valarray_meta, swig_double_valarray_bases, swig_double_valarray_base_names };
...
static int _wrap_new_AAUpSampleFilter(lua_State* L) {
  int SWIG_arg = 0;
  double arg1 ;
  Filters::AAFilter::AAUpSampleFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AAFilter::AAUpSampleFilter::AAUpSampleFilter",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::AAUpSampleFilter",1,"double");
  arg1 = (double)lua_tonumber(L, 1);
  result = (Filters::AAFilter::AAUpSampleFilter *)new Filters::AAFilter::AAUpSampleFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AAFilter__AAUpSampleFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_AAUpSampleFilter_Tick__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAUpSampleFilter *arg1 = (Filters::AAFilter::AAUpSampleFilter *) 0 ;
  double arg2 ;
  double arg3 ;
  double arg4 ;
  double arg5 ;
  ...
  SWIG_check_num_args("Filters::AAFilter::AAUpSampleFilter::Tick",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",1,"Filters::AAFilter::AAUpSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",3,"double");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",4,"double");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",5,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAUpSampleFilter,0))){
    SWIG_fail_ptr("AAUpSampleFilter_Tick",1,SWIGTYPE_p_Filters__AAFilter__AAUpSampleFilter);
  }
...
static int _wrap_AAUpSampleFilter_Tick__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAUpSampleFilter *arg1 = (Filters::AAFilter::AAUpSampleFilter *) 0 ;
  double arg2 ;
  double arg3 ;
  ...
  SWIG_check_num_args("Filters::AAFilter::AAUpSampleFilter::Tick",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",1,"Filters::AAFilter::AAUpSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",3,"double");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",4,"double");
...
static int _wrap_AAUpSampleFilter_Tick__SWIG_2(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAUpSampleFilter *arg1 = (Filters::AAFilter::AAUpSampleFilter *) 0 ;
  double arg2 ;
  double arg3 ;
  ...
  SWIG_check_num_args("Filters::AAFilter::AAUpSampleFilter::Tick",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",1,"Filters::AAFilter::AAUpSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",3,"double");
...
static int _wrap_AAUpSampleFilter_Tick__SWIG_3(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAUpSampleFilter *arg1 = (Filters::AAFilter::AAUpSampleFilter *) 0 ;
  double arg2 ;
  double result;
  
  SWIG_check_num_args("Filters::AAFilter::AAUpSampleFilter::Tick",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",1,"Filters::AAFilter::AAUpSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAUpSampleFilter::Tick",2,"double");
...
static int _wrap_AAUpSampleFilter_Tick(lua_State* L) {
  int argc;
  int argv[6]={
    1,2,3,4,5,6
  };
  ...
  if (argc == 2) {
    ...
    {
      void *ptr;
      if (SWIG_isptrtype(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_Filters__AAFilter__AAUpSampleFilter, 0)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_AAUpSampleFilter_Tick__SWIG_3(L);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_AAUpSampleFilter_Tick__SWIG_2(L);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            return _wrap_AAUpSampleFilter_Tick__SWIG_1(L);
          }
        }
      }
    }
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            ...
            if (_v) {
              return _wrap_AAUpSampleFilter_Tick__SWIG_0(L);
            }
          }
        }
      }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'AAUpSampleFilter_Tick'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Filters::AAFilter::AAUpSampleFilter::Tick(double,double,double,double)\n"
    "    Filters::AAFilter::AAUpSampleFilter::Tick(double,double,double)\n"
    "    Filters::AAFilter::AAUpSampleFilter::Tick(double,double)\n"
    "    Filters::AAFilter::AAUpSampleFilter::Tick(double)\n");
  lua_error(L);return 0;
}


static void swig_delete_AAUpSampleFilter(void *obj) {
Filters::AAFilter::AAUpSampleFilter *arg1 = (Filters::AAFilter::AAUpSampleFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_AAUpSampleFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_AAUpSampleFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_AAUpSampleFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_AAUpSampleFilter_methods[]= {
    { "Tick", _wrap_AAUpSampleFilter_Tick},
    {0,0}
};
static swig_lua_method swig_AAUpSampleFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_AAUpSampleFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_AAUpSampleFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_AAUpSampleFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_AAUpSampleFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_AAUpSampleFilter_Sf_SwigStatic = {
    "AAUpSampleFilter",
    swig_AAUpSampleFilter_Sf_SwigStatic_methods,
    swig_AAUpSampleFilter_Sf_SwigStatic_attributes,
    swig_AAUpSampleFilter_Sf_SwigStatic_constants,
    swig_AAUpSampleFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_AAUpSampleFilter_bases[] = {0};
static const char *swig_AAUpSampleFilter_base_names[] = {0};
static swig_lua_class _wrap_class_AAUpSampleFilter = { "AAUpSampleFilter", "AAUpSampleFilter", &SWIGTYPE_p_Filters__AAFilter__AAUpSampleFilter,_proxy__wrap_new_AAUpSampleFilter, swig_delete_AAUpSampleFilter, swig_AAUpSampleFilter_methods, swig_AAUpSampleFilter_attributes, &swig_AAUpSampleFilter_Sf_SwigStatic, swig_AAUpSampleFilter_meta, swig_AAUpSampleFilter_bases, swig_AAUpSampleFilter_base_names };

static int _wrap_new_AADownSampleFilter(lua_State* L) {
  int SWIG_arg = 0;
  double arg1 ;
  Filters::AAFilter::AADownSampleFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AAFilter::AADownSampleFilter::AADownSampleFilter",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::AADownSampleFilter",1,"double");
  arg1 = (double)lua_tonumber(L, 1);
  result = (Filters::AAFilter::AADownSampleFilter *)new Filters::AAFilter::AADownSampleFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AAFilter__AADownSampleFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_AADownSampleFilter_Tick__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AADownSampleFilter *arg1 = (Filters::AAFilter::AADownSampleFilter *) 0 ;
  double arg2 ;
  double arg3 ;
  double arg4 ;
  double arg5 ;
  ...
  SWIG_check_num_args("Filters::AAFilter::AADownSampleFilter::Tick",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",1,"Filters::AAFilter::AADownSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",3,"double");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",4,"double");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",5,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AADownSampleFilter,0))){
    SWIG_fail_ptr("AADownSampleFilter_Tick",1,SWIGTYPE_p_Filters__AAFilter__AADownSampleFilter);
  }
...
static int _wrap_AADownSampleFilter_Tick__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AADownSampleFilter *arg1 = (Filters::AAFilter::AADownSampleFilter *) 0 ;
  double arg2 ;
  double arg3 ;
  ...
  SWIG_check_num_args("Filters::AAFilter::AADownSampleFilter::Tick",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",1,"Filters::AAFilter::AADownSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",3,"double");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",4,"double");
...
static int _wrap_AADownSampleFilter_Tick__SWIG_2(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AADownSampleFilter *arg1 = (Filters::AAFilter::AADownSampleFilter *) 0 ;
  double arg2 ;
  double arg3 ;
  ...
  SWIG_check_num_args("Filters::AAFilter::AADownSampleFilter::Tick",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",1,"Filters::AAFilter::AADownSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",3,"double");
...
static int _wrap_AADownSampleFilter_Tick__SWIG_3(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AADownSampleFilter *arg1 = (Filters::AAFilter::AADownSampleFilter *) 0 ;
  double arg2 ;
  double result;
  
  SWIG_check_num_args("Filters::AAFilter::AADownSampleFilter::Tick",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",1,"Filters::AAFilter::AADownSampleFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AADownSampleFilter::Tick",2,"double");
...
static int _wrap_AADownSampleFilter_Tick(lua_State* L) {
  int argc;
  int argv[6]={
    1,2,3,4,5,6
  };
  ...
  if (argc == 2) {
    ...
    {
      void *ptr;
      if (SWIG_isptrtype(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_Filters__AAFilter__AADownSampleFilter, 0)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_AADownSampleFilter_Tick__SWIG_3(L);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_AADownSampleFilter_Tick__SWIG_2(L);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            return _wrap_AADownSampleFilter_Tick__SWIG_1(L);
          }
        }
      }
    }
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            ...
            if (_v) {
              return _wrap_AADownSampleFilter_Tick__SWIG_0(L);
            }
          }
        }
      }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'AADownSampleFilter_Tick'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Filters::AAFilter::AADownSampleFilter::Tick(double,double,double,double)\n"
    "    Filters::AAFilter::AADownSampleFilter::Tick(double,double,double)\n"
    "    Filters::AAFilter::AADownSampleFilter::Tick(double,double)\n"
    "    Filters::AAFilter::AADownSampleFilter::Tick(double)\n");
  lua_error(L);return 0;
}


static void swig_delete_AADownSampleFilter(void *obj) {
Filters::AAFilter::AADownSampleFilter *arg1 = (Filters::AAFilter::AADownSampleFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_AADownSampleFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_AADownSampleFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_AADownSampleFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_AADownSampleFilter_methods[]= {
    { "Tick", _wrap_AADownSampleFilter_Tick},
    {0,0}
};
static swig_lua_method swig_AADownSampleFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_AADownSampleFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_AADownSampleFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_AADownSampleFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_AADownSampleFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_AADownSampleFilter_Sf_SwigStatic = {
    "AADownSampleFilter",
    swig_AADownSampleFilter_Sf_SwigStatic_methods,
    swig_AADownSampleFilter_Sf_SwigStatic_attributes,
    swig_AADownSampleFilter_Sf_SwigStatic_constants,
    swig_AADownSampleFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_AADownSampleFilter_bases[] = {0};
static const char *swig_AADownSampleFilter_base_names[] = {0};
static swig_lua_class _wrap_class_AADownSampleFilter = { "AADownSampleFilter", "AADownSampleFilter", &SWIGTYPE_p_Filters__AAFilter__AADownSampleFilter,_proxy__wrap_new_AADownSampleFilter, swig_delete_AADownSampleFilter, swig_AADownSampleFilter_methods, swig_AADownSampleFilter_attributes, &swig_AADownSampleFilter_Sf_SwigStatic, swig_AADownSampleFilter_meta, swig_AADownSampleFilter_bases, swig_AADownSampleFilter_base_names };

static int _wrap_aafilter_float_Init(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< float > *arg1 = (Filters::AAFilter::AAFilter< float > *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< float >::Init",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::Init",1,"Filters::AAFilter::AAFilter< float > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::Init",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t,0))){
    SWIG_fail_ptr("aafilter_float_Init",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t);
  }
...
static int _wrap_aafilter_float_ProcessUp(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< float > *arg1 = (Filters::AAFilter::AAFilter< float > *) 0 ;
  float arg2 ;
  float result;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< float >::ProcessUp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::ProcessUp",1,"Filters::AAFilter::AAFilter< float > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::ProcessUp",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t,0))){
    SWIG_fail_ptr("aafilter_float_ProcessUp",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = (float)(arg1)->ProcessUp(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_aafilter_float_ProcessDown(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< float > *arg1 = (Filters::AAFilter::AAFilter< float > *) 0 ;
  float arg2 ;
  float result;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< float >::ProcessDown",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::ProcessDown",1,"Filters::AAFilter::AAFilter< float > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::ProcessDown",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t,0))){
    SWIG_fail_ptr("aafilter_float_ProcessDown",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = (float)(arg1)->ProcessDown(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_aafilter_float_GetOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< float > *arg1 = (Filters::AAFilter::AAFilter< float > *) 0 ;
  int result;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< float >::GetOversamplingFactor",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< float >::GetOversamplingFactor",1,"Filters::AAFilter::AAFilter< float > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t,0))){
    SWIG_fail_ptr("aafilter_float_GetOversamplingFactor",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t);
  }
  
  result = (int)(arg1)->GetOversamplingFactor();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_new_aafilter_float(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< float > *result = 0 ;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< float >::AAFilter",0,0)
  result = (Filters::AAFilter::AAFilter< float > *)new Filters::AAFilter::AAFilter< float >();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_aafilter_float(void *obj) {
Filters::AAFilter::AAFilter< float > *arg1 = (Filters::AAFilter::AAFilter< float > *) obj;
delete arg1;
}
static int _proxy__wrap_new_aafilter_float(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_aafilter_float);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_aafilter_float_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_aafilter_float_methods[]= {
    { "Init", _wrap_aafilter_float_Init},
    { "ProcessUp", _wrap_aafilter_float_ProcessUp},
    { "ProcessDown", _wrap_aafilter_float_ProcessDown},
    { "GetOversamplingFactor", _wrap_aafilter_float_GetOversamplingFactor},
    {0,0}
};
static swig_lua_method swig_aafilter_float_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_aafilter_float_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_aafilter_float_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_aafilter_float_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_aafilter_float_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_aafilter_float_Sf_SwigStatic = {
    "aafilter_float",
    swig_aafilter_float_Sf_SwigStatic_methods,
    swig_aafilter_float_Sf_SwigStatic_attributes,
    swig_aafilter_float_Sf_SwigStatic_constants,
    swig_aafilter_float_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_aafilter_float_bases[] = {0};
static const char *swig_aafilter_float_base_names[] = {0};
static swig_lua_class _wrap_class_aafilter_float = { "aafilter_float", "aafilter_float", &SWIGTYPE_p_Filters__AAFilter__AAFilterT_float_t,_proxy__wrap_new_aafilter_float, swig_delete_aafilter_float, swig_aafilter_float_methods, swig_aafilter_float_attributes, &swig_aafilter_float_Sf_SwigStatic, swig_aafilter_float_meta, swig_aafilter_float_bases, swig_aafilter_float_base_names };

static int _wrap_aafilter_double_Init(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< double > *arg1 = (Filters::AAFilter::AAFilter< double > *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< double >::Init",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::Init",1,"Filters::AAFilter::AAFilter< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::Init",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t,0))){
    SWIG_fail_ptr("aafilter_double_Init",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t);
  }
...
static int _wrap_aafilter_double_ProcessUp(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< double > *arg1 = (Filters::AAFilter::AAFilter< double > *) 0 ;
  double arg2 ;
  double result;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< double >::ProcessUp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::ProcessUp",1,"Filters::AAFilter::AAFilter< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::ProcessUp",2,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t,0))){
    SWIG_fail_ptr("aafilter_double_ProcessUp",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t);
  }
  
  arg2 = (double)lua_tonumber(L, 2);
  result = (double)(arg1)->ProcessUp(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_aafilter_double_ProcessDown(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< double > *arg1 = (Filters::AAFilter::AAFilter< double > *) 0 ;
  double arg2 ;
  double result;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< double >::ProcessDown",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::ProcessDown",1,"Filters::AAFilter::AAFilter< double > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::ProcessDown",2,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t,0))){
    SWIG_fail_ptr("aafilter_double_ProcessDown",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t);
  }
  
  arg2 = (double)lua_tonumber(L, 2);
  result = (double)(arg1)->ProcessDown(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_aafilter_double_GetOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< double > *arg1 = (Filters::AAFilter::AAFilter< double > *) 0 ;
  int result;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< double >::GetOversamplingFactor",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AAFilter::AAFilter< double >::GetOversamplingFactor",1,"Filters::AAFilter::AAFilter< double > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t,0))){
    SWIG_fail_ptr("aafilter_double_GetOversamplingFactor",1,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t);
  }
...
static int _wrap_new_aafilter_double(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AAFilter::AAFilter< double > *result = 0 ;
  
  SWIG_check_num_args("Filters::AAFilter::AAFilter< double >::AAFilter",0,0)
  result = (Filters::AAFilter::AAFilter< double > *)new Filters::AAFilter::AAFilter< double >();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_aafilter_double(void *obj) {
Filters::AAFilter::AAFilter< double > *arg1 = (Filters::AAFilter::AAFilter< double > *) obj;
delete arg1;
}
static int _proxy__wrap_new_aafilter_double(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_aafilter_double);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_aafilter_double_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_aafilter_double_methods[]= {
    { "Init", _wrap_aafilter_double_Init},
    { "ProcessUp", _wrap_aafilter_double_ProcessUp},
    { "ProcessDown", _wrap_aafilter_double_ProcessDown},
    { "GetOversamplingFactor", _wrap_aafilter_double_GetOversamplingFactor},
    {0,0}
};
static swig_lua_method swig_aafilter_double_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_aafilter_double_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_aafilter_double_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_aafilter_double_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_aafilter_double_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_aafilter_double_Sf_SwigStatic = {
    "aafilter_double",
    swig_aafilter_double_Sf_SwigStatic_methods,
    swig_aafilter_double_Sf_SwigStatic_attributes,
    swig_aafilter_double_Sf_SwigStatic_constants,
    swig_aafilter_double_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_aafilter_double_bases[] = {0};
static const char *swig_aafilter_double_base_names[] = {0};
static swig_lua_class _wrap_class_aafilter_double = { "aafilter_double", "aafilter_double", &SWIGTYPE_p_Filters__AAFilter__AAFilterT_double_t,_proxy__wrap_new_aafilter_double, swig_delete_aafilter_double, swig_aafilter_double_methods, swig_aafilter_double_attributes, &swig_aafilter_double_Sf_SwigStatic, swig_aafilter_double_meta, swig_aafilter_double_bases, swig_aafilter_double_base_names };
...
&_wrap_class_AAUpSampleFilter,
&_wrap_class_AADownSampleFilter,
&_wrap_class_aafilter_float,
&_wrap_class_aafilter_double,
    0
};
...
static swig_type_info _swigt__p_Filters__AAFilter__AADownSampleFilter = {"_p_Filters__AAFilter__AADownSampleFilter", "Filters::AAFilter::AADownSampleFilter *", 0, 0, (void*)&_wrap_class_AADownSampleFilter, 0};
static swig_type_info _swigt__p_Filters__AAFilter__AAFilterT_double_t = {"_p_Filters__AAFilter__AAFilterT_double_t", "Filters::AAFilter::AAFilter< double > *", 0, 0, (void*)&_wrap_class_aafilter_double, 0};
static swig_type_info _swigt__p_Filters__AAFilter__AAFilterT_float_t = {"_p_Filters__AAFilter__AAFilterT_float_t", "Filters::AAFilter::AAFilter< float > *", 0, 0, (void*)&_wrap_class_aafilter_float, 0};
static swig_type_info _swigt__p_Filters__AAFilter__AAUpSampleFilter = {"_p_Filters__AAFilter__AAUpSampleFilter", "Filters::AAFilter::AAUpSampleFilter *", 0, 0, (void*)&_wrap_class_AAUpSampleFilter, 0};
...
static swig_type_info _swigt__p_f_r_q_const__double__double = {"_p_f_r_q_const__double__double", "double (*)(double const &)", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__indirect_arrayT_double_t = {"_p_std__indirect_arrayT_double_t", "std::indirect_array< double > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__mask_arrayT_double_t = {"_p_std__mask_arrayT_double_t", "std::mask_array< double > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__valarrayT_double_t = {"_p_std__valarrayT_double_t", "std::valarray< double > *", 0, 0, (void*)&_wrap_class_double_valarray, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Filters__AAFilter__AADownSampleFilter,
  &_swigt__p_Filters__AAFilter__AAFilterT_double_t,
  &_swigt__p_Filters__AAFilter__AAFilterT_float_t,
  &_swigt__p_Filters__AAFilter__AAUpSampleFilter,
  &_swigt__p_double,
  &_swigt__p_f_double__double,
  &_swigt__p_f_float__float,
  &_swigt__p_f_r_q_const__double__double,
  ...
  &_swigt__p_std__indirect_arrayT_double_t,
  &_swigt__p_std__indirect_arrayT_float_t,
  &_swigt__p_std__mask_arrayT_double_t,
...
static swig_cast_info _swigc__p_Filters__AAFilter__AADownSampleFilter[] = {  {&_swigt__p_Filters__AAFilter__AADownSampleFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Filters__AAFilter__AAFilterT_double_t[] = {  {&_swigt__p_Filters__AAFilter__AAFilterT_double_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Filters__AAFilter__AAFilterT_float_t[] = {  {&_swigt__p_Filters__AAFilter__AAFilterT_float_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Filters__AAFilter__AAUpSampleFilter[] = {  {&_swigt__p_Filters__AAFilter__AAUpSampleFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_f_r_q_const__double__double[] = {  {&_swigt__p_f_r_q_const__double__double, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__indirect_arrayT_double_t[] = {  {&_swigt__p_std__indirect_arrayT_double_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__indirect_arrayT_float_t[] = {  {&_swigt__p_std__indirect_arrayT_float_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__mask_arrayT_double_t[] = {  {&_swigt__p_std__mask_arrayT_double_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_Filters__AAFilter__AADownSampleFilter,
  _swigc__p_Filters__AAFilter__AAFilterT_double_t,
  _swigc__p_Filters__AAFilter__AAFilterT_float_t,
  _swigc__p_Filters__AAFilter__AAUpSampleFilter,
  _swigc__p_double,
  _swigc__p_f_double__double,
  _swigc__p_f_float__float,
  _swigc__p_f_r_q_const__double__double,
  ...
  _swigc__p_std__indirect_arrayT_double_t,
  _swigc__p_std__indirect_arrayT_float_t,
  _swigc__p_std__mask_arrayT_double_t,
