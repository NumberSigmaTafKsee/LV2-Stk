...
#define SWIGTYPE_p_LV2Plugin swig_types[0]
#define SWIGTYPE_p_LV2Plugins swig_types[1]
#define SWIGTYPE_p_Lilv__Node swig_types[2]
#define SWIGTYPE_p_Lilv__Plugin swig_types[3]
...
static int _wrap_LV2Plugin_InplaceProcess(lua_State* L) {
  int SWIG_arg = 0;
  LV2Plugin *arg1 = (LV2Plugin *) 0 ;
  size_t arg2 ;
  float *arg3 = (float *) 0 ;
  
  SWIG_check_num_args("LV2Plugin::InplaceProcess",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("LV2Plugin::InplaceProcess",1,"LV2Plugin *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("LV2Plugin::InplaceProcess",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("LV2Plugin::InplaceProcess",3,"float *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_LV2Plugin,0))){
    SWIG_fail_ptr("LV2Plugin_InplaceProcess",1,SWIGTYPE_p_LV2Plugin);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("LV2Plugin_InplaceProcess",3,SWIGTYPE_p_float);
  }
...
static swig_lua_method swig_LV2Plugin_methods[]= {
    ...
    { "InplaceProcess", _wrap_LV2Plugin_InplaceProcess},
