swig -lua -c++ -Iinclude -Iinclude/Eigen -Iinclude/SimpleEigen simple_eigen.i
gcc -fmax-errors=1 -Iinclude -Iinclude/SimpleEigen -O2 -fPIC -march=native -shared -osimple_eigen.so simple_eigen_wrap.cxx -lstdc++ -lluajit -L/usr/local/cuda/lib64 -lnvblas -lopenblas -llapacke
